...
class abrechnung extends basis_db
{
	...
	public function getLetzteAbrechnung($mitarbeiter_uid, $startdatum=null)
	{
		...
		else
		{
			...
			return false;
              ...
              /**
	 * Prueft ob eine gesplittete Jahressechstelberechnung durchgef�hrt wird
	 * @param $username
	 * @return boolean
	 */
	...
	public function abrechnung($username, $abrechnungsdatum, $verwendung_obj)
	{
		...
		$this->honorar_offen = $honorar_offen;
                ...
                // Standard f�r die WS Abrechnung 09-12 und die SS Abrechnung                                
                $honorar_ausbezahlt = $honorar_durchgefuehrt + ($honorar_durchgefuehrt/6);
                
                // F�r die WS-Abrechnung im J�nner darf die Sonderzahlung der bisher durchgef�hrten Abrechnungsmonate nicht ber�cksichtigt werden.
